...
public class LeetsMateApplication {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("[ERROR] 이름은 한글로 입력해야 합니다");
            System.out.println("멤버의 이름을 다시 입력해 주세요. (, 로 구분)");
        ...
        try {
            ...
            System.out.println("[ERROR] 최대 짝 수는 이름의 갯수보다 클 수 없습니다.");
        ...
        while (index.equals("y")){
            List<List<String>> result = generateRandomGroups(memberList, maxGroup);
            printResult(result);
            System.out.println("다시 추첨하시겠습니까?");
            index = scan.nextLine();
        }
    }
